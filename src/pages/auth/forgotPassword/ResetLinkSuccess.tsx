...
export default function ResetLinkSuccess() {
  useMetaArgs({
    title: "Reset Link Sent - TechPay",
    description: "Reset Link Sent to your TechPay account, reset it here.",
    keywords: "techpay, finance, reset link, account",
  });
  ...
  return (
    <main className="auth-bg min-h-screen flex items-center justify-center">
      <div className="text-center">
        ...
        <h1 className="text-[1.3rem] font-bold mb-5">Reset link sent!</h1>
